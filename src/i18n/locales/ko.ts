export const ko = {
  ...
  curriculumManagement: "커리큘럼 관리",
  courseManagement: "과정 관리",
  assignmentsGames: "과제 및 게임",
  examManagement: "시험 관리",
  documentLibrary: "문서 라이브러리",
  gamificationGrading: "게임화 및 채점",
  usersRoles: "사용자 및 역할",
  analyticsReports: "분석 및 보고서",

  // Dashboard
  dashboardOverview: "대시보드 개요",
  dashboardWelcome:
    "다시 오신 것을 환영합니다! 교육 시스템에서 일어나고 있는 일입니다.",
  totalClasses: "총 학급 수",
  totalStudents: "총 학생 수",
  activeCourses: "활성 과정",
  completionRate: "완료율",
  fromLastMonth: "지난달 대비",
  courseCompletionStatus: "과정 완료 상태",
  growthTrends: "성장 추세",
  ...
  // Settings Page
  settings: "설정",
  manageSettings: "계정 설정 및 기본 설정 관리",
  ...
  emailNotificationsDesc: "계정에 대한 이메일 업데이트 받기",
  pushNotifications: "푸시 알림",
  pushNotificationsDesc: "기기에서 푸시 알림 받기",
  smsNotifications: "SMS 알림",
  smsNotificationsDesc: "중요한 업데이트에 대한 문자 메시지 받기",
  weeklyReports: "주간 보고서",
  weeklyReportsDesc: "주간 활동 요약 받기",
  ...
  // Data & Privacy
  privacyMessage:
    "귀하의 개인정보를 중요하게 생각합니다. 귀하의 데이터는 암호화되어 안전하게 저장됩니다.",
  ...
  aiAssistantReady: "언제든지 도와드릴 준비가 되어 있습니다",
  aiAssistantWelcome:
    "안녕하세요! 저는 SysEdu의 AI 어시스턴트입니다. 무엇을 도와드릴까요?",
  aiAssistantProcessing: "연락 주셔서 감사합니다! 요청을 처리하고 있습니다...",
  typeMessage: "메시지를 입력하세요...",
  sendMessage: "메시지 보내기",
  closeChat: "채팅 닫기",
  openAIAssistant: "AI 어시스턴트 열기",
  closeAIAssistant: "AI 어시스턴트 닫기",

  // AI Assistant Panel
  aiAssistantTitle: "홈룸 AI 어시스턴트",
  aiAssistantSubtitle: "지능형 분석 및 행동 권장사항",
  aiAnalysis: "AI 분석",
  aiInsights: "AI 인사이트",
  analyzingData: "대시보드 데이터 분석 중...",
  refreshAnalysis: "분석 새로고침",
  noActionsRecommended: "권장 작업 없음",
  actionsRecommended: "권장 작업",
  highPriority: "높은 우선순위",
  mediumPriority: "중간 우선순위",
  lowPriority: "제안",
  expandMore: "더 보기",
  collapseText: "접기",
  aiLoadError: "분석 데이터를 로드할 수 없습니다",
  retryAction: "다시 시도",
  aiFeatureDisabled: "AI 어시스턴트 기능이 현재 비활성화되어 있습니다",
  aiApiKeyMissing: "Gemini API 키가 구성되지 않았습니다",
  aiRateLimitExceeded: "속도 제한을 초과했습니다. 나중에 다시 시도하세요",
  aiNetworkError: "네트워크 오류. 연결을 확인하세요",
  aiTimeoutError: "요청 시간 초과. 다시 시도하세요",
  aiInvalidResponse: "AI 서비스의 응답이 유효하지 않습니다",
};
