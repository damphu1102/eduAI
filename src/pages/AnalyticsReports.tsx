    ...
    <Layout>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          {/* Daily Engagement */}
          <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Daily Engagement (Hours)</h3>
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          <div className="px-6 py-4 border-b border-gray-200">
            <h3 className="text-lg font-semibold text-gray-900">Detailed Performance Reports</h3>
          </div>
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {[
                  { class: 'Mathematics 10A', students: 32, avgScore: 85, completion: 92, engagement: 88, trend: 'up' },
                  { class: 'Physics 11B', students: 28, avgScore: 78, completion: 87, engagement: 85, trend: 'up' },
                  { class: 'Chemistry 12C', students: 25, avgScore: 92, completion: 95, engagement: 91, trend: 'up' },
                  { class: 'Biology 9A', students: 30, avgScore: 88, completion: 89, engagement: 86, trend: 'down' }
                ].map((row, index) => (
                  <tr key={index} className="hover:bg-gray-50">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm font-medium text-gray-900">{row.class}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">{row.students}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">{row.avgScore}%</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">{row.completion}%</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">{row.engagement}%</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <TrendingUp className={`w-4 h-4 ${row.trend === 'up' ? 'text-green-500' : 'text-red-500'} ${row.trend === 'down' ? 'transform rotate-180' : ''}`} />
                    </td>
                  </tr>
                ))}
              </tbody>
